    ...
    def __init__(self, token_path, skip_special_tokens=True):
        ...
        special_tokens = {
            ...
            'additional_special_tokens': [
                ...
                '[breathy exhale]', '[chuckle]', '[clearing throat]', '[click]', '[content sigh]', '[deep inhale]', '[exhale]',
                '[gag]', '[gasp]', '[giggle]', '[giggly laugh]', '[groan]', '[grunt]', '[heavy breathing]', '[hiss]', '[hum]',
                '[humming]', '[inhale]', '[kiss]', '[kissing]', '[kissing sound]', '[laugh]','[mmm]', '[moan]', '[mouth click]',
                '[mouth sound]', '[mouth sounds]', '[panting]', '[pleasurable moan]', '[purr]', '[quick gasp]', '[shaky breath]',
                '[shout]', '[shushing sound]', '[shushing]', '[sigh]', '[slurp]', '[smack]', '[sniff]', '[sob]',  '[soft laugh]',
                '[soft sigh]', '[sucking sound]', '[tongue click]', '[tsk]', '[whimper]', '[yawn]',  '[yelp]', '<cry>', '</cry>',
                '<groan>', '</groan>', '<laughter>', '</laughter>', '<moan>', '</moan>', '<shout>', '</shout>', '<soft laugh>',
                '</soft laugh>', '<soft sigh>', '</soft sigh>', '<whisper>', '</whisper>'
            ]
        }
        self.special_tokens = special_tokens
        self.tokenizer = AutoTokenizer.from_pretrained(token_path)
